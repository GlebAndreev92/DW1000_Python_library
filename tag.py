...
def setup():
    ...
    dw1000.syscfg.setBits((C.DIS_STXP_BIT, C.RXAUTR_BIT, C.FFEN_BIT, C.FFAA_BIT, C.FFAD_BIT, C.RXWTOE_BIT), True)
    dw1000.writeRegister(dw1000.syscfg)

    # Set HSRBP to ICRBP for double buffering
    dw1000.syncHSRBP()

    dw1000.setFrameWaitTimeout(7000)
...
def main():
    global Send, Acked, Timeouts, work
    try:
        setup()
