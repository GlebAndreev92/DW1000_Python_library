...
def setup():
    ...
    # Enable automatic rx reenable, frame filtering (acknowledge frame)
    # Disable smart tx power
    dw1000.syscfg.setBits((C.DIS_STXP_BIT, C.RXAUTR_BIT, C.FFEN_BIT, C.FFAA_BIT), True)
    ...
    dw1000.sysmask.setBits((C.MRXOVRR_BIT, C.MRXDFR_BIT), True)
...
def main():
    try:
        ...
        while 1:
            dw1000.sendMessage(b"\x11\x3b", b"\xca\xde", b"abcdefghi123456789")
            time.sleep(5)
